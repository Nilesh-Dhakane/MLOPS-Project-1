...
class DataIngestion:
    ...
    def __init__(self, config):
        ...
        logger.info(f"DAta Ingestion Satred with {self.bucket_name}, filename is -{self.bucket_file_name} ")
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.info("Raw file is successfully downloaded to raw file path")
    ...
    def split_data(self):
        try:
            ...
            logger.error("Error while splitting the data file")
            raise CustomException("Failed to split csv file",e)
